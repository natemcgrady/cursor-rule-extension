...
1. Download the `cursor-create-rule-from-selection-0.0.1.vsix` file from the [GitHub repository](https://github.com/natemcgrady/cursor-rule-extension)
2. Install the extension using Cursor:
   ```bash
   cursor --install-extension cursor-create-rule-from-selection-0.0.1.vsix
   ```
